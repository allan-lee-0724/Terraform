...
# provider in our terraform.tf file, where we defined our required_provider
provider "aws" {
...
module "ec2-instance"{
    ...
    monitoring             = false
    vpc_security_group_ids = ["sg-042d4bcfa8912a50f"] # you can place multiple security groups in your list
